...
def create_channel():
    ...
    #check it already exists and return an error if it does
...
#return messages to client when they join a channel
...
def get_chat():
    ...
    #on initial page load when server starts we would have missing information in this call
...
def chatSent(data):
    ...
    #server terminal output to ensure max length is being maintained
